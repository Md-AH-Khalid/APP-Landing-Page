(function ($) {
  ...
  /*=================================*/
	...
	var AdvancedMenu = function($scope, $) {
		// insert indicator
		$('.eael-advanced-menu li.menu-item-has-children', $scope).each(function(e) {
			// indicator position
			var $height = parseInt($('a', this).css('line-height'))  / 2
			$(this).append('<span class="eael-advanced-menu-vertical-indicator" style="top:' + $height + 'px"></span>')

			// if current, keep indicator open
			$(this).hasClass('current-menu-ancestor') ? $(this).addClass('eael-advanced-menu-vertical-toggle-open') : ''
		})

		// horizontal menu indent
		$('.eael-advanced-menu-align-left .eael-advanced-menu-vertical li.menu-item-has-children').each(function() {
		...
		$('.eael-advanced-menu-align-right .eael-advanced-menu-vertical li.menu-item-has-children').each(function() {
		...
		$('.eael-advanced-menu', $scope).on('click', '.eael-advanced-menu-vertical-indicator', function(e) {
			e.preventDefault()
			$(this).toggleClass('eael-advanced-menu-vertical-toggle-open')
			$(this).hasClass('eael-advanced-menu-vertical-toggle-open') ? $(this).siblings('ul').slideDown(300) : $(this).siblings('ul').slideUp(300)
		})
